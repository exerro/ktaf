...
import ktaf.data.animation.AnimationParameter
import ktaf.data.animation.EasingFunctions

fun floatAnimatedProperty(value: Float, fn: AnimatedProperty<Float>.() -> Unit = {})
        = AnimatedProperty(value, Animation.Companion::lerp).also(fn)

fun vec2AnimatedProperty(value: vec2, fn: AnimatedProperty<vec2>.() -> Unit = {})
